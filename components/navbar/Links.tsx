...
function Links() {
  ...
  return (
    <nav
      className='flex flex-col sm:flex-row flex-wrap justify-center lg:justify-end gap-2 text-base'
      role='navigation'
      aria-label='Main navigation'
    >
      {navItems.map((item) => {
        ...
        return (
          <Link
            ...
            className='
              ...
              hover:bg-violet-500/20 focus:bg-violet-500/30
              focus:outline-none focus:ring-2 focus:ring-white/30
              backdrop-blur-sm
          ...
          >
            <IconComponent
              className='h-5 w-5 opacity-80 group-hover:opacity-100 transition-all duration-300 group-hover:scale-110'
              aria-hidden='true'
            />
            <span
              className='
            ...
            <span
              className='
                ...
                w-0 h-0.5 bg-gradient-to-r from-gray-100 to-gray-400 rounded-full
                group-hover:w-3/4 transition-all duration-400
              '
            />
          </Link>
        );
